...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            {
                Console.WriteLine(
                    $"We currently have {petCount} pets that need home. We can manage {(maxPets - petCount)} more."
                );
            }
                ...
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 2] == "Age: ?")
                    {
                        ...
                        do
                        {
                            ...
                            {
                                animalAge = readResult;
                                Type ageType = animalAge.GetType();

                                if (!ageType.Equals(typeof(int)))
                                {
                                    validAgeEntry = int.TryParse(animalAge, out petAge);
                                }
                                else
                                {
                                    validAgeEntry = true;
